                            ...
                            @endif
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="{{ URL::to('blogs-submit') }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row mb-2">
                                                <div class="col-sm-12">
                                                    <div class="mb-3">
                                                        <label for="example-input-normal" class="form-label">Title</label>
                                                        <input type="text" id="example-input-normal"  name="title" value="{{ old('title') }}" class="form-control" placeholder="Normal">
                                                        @error('title')
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="mb-3">
                                                        <label for="example-input-normal" class="form-label">Short Description</label>
                                                        <textarea  name="short_description" value="{{ old('short_description') }}" class="form-control" placeholder="Normal">
