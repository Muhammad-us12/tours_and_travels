                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Visa Request List</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table id="scroll-horizontal-datatable" class="table table-centered w-100 nowrap">
                                                ...
                                                <tbody>
                                                    @isset($visa_requests)
                                                        @foreach($visa_requests as $package_res)
                                                            <tr>
                                                                <td>
                                                                    {{ $loop->iteration }}
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <img src="{{ asset('public/images/visa/'.$package_res->passport_img.'') }}" style="width:150px; height:150px;" alt="">
                                                                </td>
                                                                <td>
                                                                    <img src="{{ asset('public/images/visa/'.$package_res->iteneray_img.'') }}" style="width:150px;height:150px;" alt="">
                                                                </td>
                                                                <td>
