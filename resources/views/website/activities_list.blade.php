        ...
        <div class="row">
          <div class="col-12">
            <div class="text-center">
              <h1 class="text-30 fw-600">Activities in London</h1>
            </div>
      ...
      <div class="container">
        <div class="row y-gap-30">
          ...
          <div class="col-xl-9 col-lg-8">
            <div class="row y-gap-10 items-center justify-between">
              <div class="col-auto">
                <div class="text-18"><span class="fw-500">{{ $all_activities->total() }}</span> Activities Found</div>
              </div>
                    ...
                    <div class="row x-gap-20 y-gap-20">
                        ...
                        <div class="col-md-5">
                            <div class="row x-gap-10 items-center">
                                <div class="col-auto">
                                <p class="text-14 lh-14 mb-5">{{ $activity_res->activity_duration }} Hours</p>
                                </div>
                                <div class="col-auto">
                            ...
                            <h3 class="text-18 lh-16 fw-500">
                                <a href="{{ URL::to('package_details/'.$activity_res->id.'') }}">
                            ...
                            <div class="text-14 lh-15 fw-500 mt-20">Group Size: {{ $activity_res->group_size }}</div>
                            
                            <div class="text-14 text-green-2 fw-500 lh-15 mt-5">Start Date: {{ date('d-m-Y',strtotime($activity_res->start_date)) }}</div>
                            <div class="text-14 text-green-2 fw-500 lh-15 mt-5">End Date: {{ date('d-m-Y',strtotime($activity_res->end_date)) }}</div>
                        </div>

                        <div class="col-md-3 text-right md:text-left">
                            <div class="d-flex x-gap-5 items-center justify-end md:justify-start">

                                @if($activity_res->stars_rating == 5)
                                ...
                                @if($activity_res->stars_rating == 4)
                                    <i class="icon-star text-10 text-yellow-1"></i>
                                ...
                                @if($activity_res->stars_rating == 3)
                                    <i class="icon-star text-10 text-yellow-1"></i>
                                ...
                                @if($activity_res->stars_rating == 2)
                                    <i class="icon-star text-10 text-yellow-1"></i>
                                ...
                                @if($activity_res->stars_rating == 1)
                                    <i class="icon-star text-10 text-yellow-1"></i>
                                @endif
                            ...
                            <div class="text-22 lh-12 fw-600 mt-5">US${{ $activity_res->adult_sale_price }}</div>
                            <div class="text-14 text-light-1 mt-5">per adult</div>


                            <a href="{{ URL::to('activity_details/'.$activity_res->id.'') }}" class="button -md -dark-1 bg-blue-1 text-white mt-24">
