              ...
              <div class="layout-pt-lg layout-pb-lg px-50">
                <div class="row justify-between">
                  ...
                  <div class="col-xl-4">
                    <div class="row justify-between items-center">
                      ...
                      <div class="col-auto">
                        <div class="text-18 fw-500 text-light-1">{{ $invoice_data->invoice_no }}</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row justify-between pt-50">
                  <div class="col-auto">
                    ...
                    <div class="text-15 fw-500 lh-15">{{ date('d-m-Y',strtotime($invoice_data->created_at)) }}</div>
                  </div>
                ...
                <?php 
                        $cart_data = json_decode($invoice_data->cart_data);
                      ?>
                <div class="row justify-between pt-50">
                  <div class="col-auto">
                    <div class="text-15 text-light-1">Start date:</div>
                    <div class="text-15 fw-500 lh-15">{{ date('d-m-Y',strtotime($cart_data->start_date)) }}</div>
                  </div>

                  <div class="col-xl-4">
                    <div class="text-15 text-light-1">End date:</div>
                    <div class="text-15 fw-500 lh-15">{{ date('d-m-Y',strtotime($cart_data->end_date)) }}</div>
                  </div>
                </div>

                <div class="row justify-between pt-50">
                  <div class="col-auto">
                    <div class="text-20 fw-500">Beyond Tours</div>
                  ...
                  <div class="col-xl-4">
                    ...
                    <div class="text-15 fw-500 mt-20">{{ $invoice_data->customer_name }}</div>
                    ...
                    <table class="table col-12">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>{{ $cart_data->booking_adults }}</td>

                          <td>{{ $cart_data->booking_childs }}</td>

                          <td>{{ $cart_data->grand_total }}</td>
                        ...
                        <tr>
                          ...
                          <td></td>
                          <td></td>
                          <td class="text-18 fw-500">${{ number_format($cart_data->grand_total) }}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
