      ...
      <div class="container">
        <div class="row y-gap-30">
          ...
          <div class="col-xl-9 col-lg-8">
            <div class="row y-gap-10 items-center justify-between">
              <div class="col-auto">
                <div class="text-18"><span class="fw-500">{{ $all_packages->total() }}</span> Packages Found</div>
              </div>
            ...
            <div class="row y-gap-30">
              @isset($all_packages)
                @foreach($all_packages as $pack_res)
                <div class="col-12">
                    ...
                    <div class="row x-gap-20 y-gap-20">
                            ...
                            <div class="hotelsCard__image">
                                ...
                                <div class="cardImage ratio ratio-1:1">
                                    ...
                                    <div class="cardImage-slider rounded-4 overflow-hidden js-cardImage-slider" style="height:100%;">
                                        ...
                                        <div class="swiper-slide">
                                            <img class="col-12" src="{{ asset('public/images/Packages/'.$pack_res->feacture_img.'') }}" style="width:100%;height:100%;" alt="image">
                                        </div>

                                        <div class="swiper-slide">
                                            <img class="col-12" src="{{ asset('public/images/Packages/'.$pack_res->baaner_img.'') }}" style="width:100%;height:100%;" alt="image">
                                        </div>
                        ...
                        <div class="col-md-5">
                            <div class="row x-gap-10 items-center">
                                <div class="col-auto">
                                <p class="text-14 lh-14 mb-5">{{ $pack_res->duration }} </p>
                                </div>
                                <div class="col-auto">
                                <div class="size-3 rounded-full bg-light-1 mb-5"></div>
                                </div>
                                <div class="col-auto">
                                <p class="text-14 lh-14 mb-5">Full-days Tours</p>
                                </div>
                            </div>

                            <h3 class="text-18 lh-16 fw-500">
                                <a href="{{ URL::to('package_details/'.$pack_res->id.'') }}">
                                    {{ $pack_res->package_title }}
                                </a>
                            </h3>
                            <div style="display:flex;">
                                <div class="icon-location-2 text-light-1 text-12 pt-4" style="margin: 5px;"></div>
                                <p class="text-light-1 lh-14 text-14 mt-5">{{ $pack_res->packageDestination->dest_name }}</p>

                            </div>
                            <div class="text-14 lh-15 fw-500 mt-20">Taking safety measures</div>
                            <div class="text-14 lh-15 fw-500 mt-20">Group Size: {{ $pack_res->group_size }}</div>
                            
                            <div class="text-14 text-green-2 fw-500 lh-15 mt-5">Start Date: {{ date('d-m-Y',strtotime($pack_res->start_date)) }}</div>
                            <div class="text-14 text-green-2 fw-500 lh-15 mt-5">End Date: {{ date('d-m-Y',strtotime($pack_res->end_date)) }}</div>
                        </div>

                        <div class="col-md-3 text-right md:text-left">
                            <div class="d-flex x-gap-5 items-center justify-end md:justify-start">

                                @if($pack_res->stars_rating == 5)
                            ...
                            <div class="text-22 lh-12 fw-600 mt-5">US${{ $pack_res->adult_sale_price }}</div>
                            <div class="text-14 text-light-1 mt-5">per adult</div>


                            <a href="{{ URL::to('package_details/'.$pack_res->id.'') }}" class="button -md -dark-1 bg-blue-1 text-white mt-24">
